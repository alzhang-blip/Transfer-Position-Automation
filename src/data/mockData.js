...
export const validationRulesMatrix = {
  TFSA_to_TFSA: { sameCX: true, notes: 'Direct transfer allowed' },
  TFSA_to_RRSP: { sameCX: true, notes: 'Contribution room check required' },
  TFSA_to_FHSA: { sameCX: true, notes: 'FHSA eligibility check required' },
  TFSA_to_Margin: { sameCX: true, notes: 'Withdrawal — no contribution impact' },
  TFSA_to_Cash: { sameCX: true, notes: 'Withdrawal to individual cash account' },
  RRSP_to_RRSP: { sameCX: true, notes: 'Direct registered transfer' },
  RRSP_to_TFSA: { sameCX: true, notes: 'Deregistration — taxable event' },
  RRSP_to_Margin: { sameCX: true, notes: 'Deregistration — taxable event' },
  RRSP_to_FHSA: { sameCX: true, notes: 'Not permitted directly' },
  FHSA_to_FHSA: { sameCX: true, notes: 'Direct transfer allowed' },
  FHSA_to_RRSP: { sameCX: true, notes: 'FHSA to RRSP rollover' },
  FHSA_to_TFSA: { sameCX: true, notes: 'Qualifying withdrawal only' },
  FHSA_to_Margin: { sameCX: true, notes: 'Taxable withdrawal' },
  Margin_to_Margin: { sameCX: true, notes: 'Direct transfer allowed' },
  Margin_to_TFSA: { sameCX: true, notes: 'Contribution room check required' },
  Margin_to_RRSP: { sameCX: true, notes: 'Contribution room check required' },
  Margin_to_FHSA: { sameCX: true, notes: 'FHSA eligibility check required' },
};
